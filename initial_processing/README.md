...
| `02_label_refine` | Refine predicted labels by subclustering broad types and manually annotating. | `space2` (CPU) |
...
| `08_plot_labels_zones` | Summary plots of cell labels and spatial zones. | `space2` (CPU) |
